 ...
 * [molsim.yml](molsim.yml)
     * Determines how your purl.obolibrary.org/obo/molsim/ redirects will be handled
     ...
     * Paste in the contents of [molsim.yml](molsim.yml)
 ...
 * [molsim.md](molsim.md)
     ...
     * Paste in the contents of [molsim.md](molsim.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
