...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/molsim-odk.yaml)
...
```
  <uri name="http://purl.obolibrary.org/obo/molsim/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/molsim-edit.obo)
for .obo formats: 

```
import: http://purl.obolibrary.org/obo/molsim/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/molsim.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
